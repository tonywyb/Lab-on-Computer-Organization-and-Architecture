...
typedef struct CacheConfig_ {
  CacheConfig_(){}
  // Initialize the data
  CacheConfig_(int a,int b,int c,int d,int e,int f, int g, int h, int i)
  {
    size = a;
    set_num = b;
    associativity = c;
...
class Cache: public Storage {
 public:
  ...
  int LRU_line(int set_index);
  int LFU_line(int set_index);
  int FIFO_line(int set_index);
  int RANDOM_line(int set_index);
