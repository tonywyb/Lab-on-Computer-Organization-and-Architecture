...
void IDEX_bubble()//addi 0,0,0
{
	...
	ID_EX_old.Ctrl_EX_ALUOp = ALU_ADD;
	ID_EX_old.Ctrl_EX_RegDst = 0;
	ID_EX_old.Ctrl_M_Branch = NOT_BRANCH;
	ID_EX_old.Ctrl_M_MemWrite = 0;
	ID_EX_old.Ctrl_M_MemRead = 0;
	ID_EX_old.Ctrl_WB_MemtoReg = 0;//ALU_out to Register
	ID_EX_old.Ctrl_WB_RegWrite = 1;
}
void IFID_bubble()//addi 0,0,0
{
	printf("decode bubble!\n");
	IF_ID_old.PC = -1;
	IF_ID_old.inst = INST_NOPE;
}
