...
/*
		if (!strcmp(name, "__global_pointer$"))
		{
...
*/
		...
		if(!strcmp(name, "a"))
		{
			a_adr = *((unsigned int*)(&elf64_sym.st_value));
		}
		if(!strcmp(name, "b"))
		{
			b_adr = *((unsigned int*)(&elf64_sym.st_value));
		}
		if(!strcmp(name, "c"))
		{
			c_adr = *((unsigned int*)(&elf64_sym.st_value));
		}
		if(!strcmp(name, "sum"))
		{
			sum_adr = *((unsigned int*)(&elf64_sym.st_value));
		}
		if(!strcmp(name, "temp"))
		{
			temp_adr = *((unsigned int*)(&elf64_sym.st_value));
		}
